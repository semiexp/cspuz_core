...
mod tests {
    ...
    fn test_solve() {
        compare_board_and_check_no_solution_case!(
            solve("https://puzz.link/p?skyscrapers/4/4/1h23i1h34ih2h1j1h2h"),
            Board {
                ...
                data: vec![
                    ...
                    Item { y: 3, x: 11, color: "black", kind: ItemKind::Num(4) },
                    Item { y: 9, x: 1, color: "black", kind: ItemKind::Num(3) },
                    Item { y: 1, x: 3, color: "black", kind: ItemKind::Num(1) },
                    Item { y: 11, x: 3, color: "black", kind: ItemKind::Num(3) },
                    ...
                    Item { y: 7, x: 5, color: "green", kind: ItemKind::Num(4) },
                    ...
                    Item { y: 9, x: 5, color: "black", kind: ItemKind::Num(2) },
                    Item { y: 9, x: 7, color: "green", kind: ItemKind::Num(4) },
                    Item { y: 9, x: 9, color: "green", kind: ItemKind::Num(3) },
                ],
