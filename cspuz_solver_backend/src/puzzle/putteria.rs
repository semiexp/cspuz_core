        ...
        compare_board_and_check_no_solution_case!(
            ...
            Board {
                ...
                data: vec![
                    ...
                    Item { y: 3, x: 7, color: "green", kind: ItemKind::Num(3) },
                    ...
                    Item { y: 5, x: 11, color: "green", kind: ItemKind::Num(2) },
                    ...
                    Item { y: 9, x: 9, color: "green", kind: ItemKind::Num(4) },
                    Item { y: 9, x: 11, color: "black", kind: ItemKind::Dot },
                    Item { y: 11, x: 1, color: "green", kind: ItemKind::Num(3) },
                    Item { y: 11, x: 3, color: "green", kind: ItemKind::Dot },
                    Item { y: 11, x: 5, color: "green", kind: ItemKind::Dot },
                    Item { y: 11, x: 7, color: "green", kind: ItemKind::Num(4) },
