...
mod tests {
    ...
    fn test_solve() {
        compare_board_and_check_no_solution_case!(
            solve("https://pzprxs.vercel.app/p?forestwalk/6/5/58gg1i2h3r4s"),
            Board {
                kind: BoardKind::Grid,
                height: 5,
                width: 6,
                data: vec![
                    ...
                    Item { y: 1, x: 5, color: "#e0ffe0", kind: ItemKind::Fill },
                    Item { y: 1, x: 7, color: "black", kind: ItemKind::Num(3) },
                    Item { y: 1, x: 9, color: "#e0ffe0", kind: ItemKind::Fill },
                    Item { y: 3, x: 1, color: "#e0ffe0", kind: ItemKind::Fill },
                    Item { y: 3, x: 9, color: "#e0ffe0", kind: ItemKind::Fill },
                    Item { y: 5, x: 7, color: "#e0ffe0", kind: ItemKind::Fill },
                    Item { y: 5, x: 9, color: "black", kind: ItemKind::Num(4) },
                    Item { y: 9, x: 1, color: "#e0ffe0", kind: ItemKind::Fill },
                    Item { y: 9, x: 3, color: "#e0ffe0", kind: ItemKind::Fill },
                    Item { y: 9, x: 9, color: "#e0ffe0", kind: ItemKind::Fill },
