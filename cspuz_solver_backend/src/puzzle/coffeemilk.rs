...
pub fn solve(url: &str) -> Result<Board, &'static str> {
    ...
    let is_line = coffeemilk::solve_coffeemilk(&clues);
...
mod tests {
    ...
    fn test_solve() {
        compare_board_and_check_no_solution_case!(
            solve("https://puzz.link/p?coffeemilk/6/5/a2b2.1.1e1a1e.21a2b2"),
            Board {
                ...
                data: vec![
                    ...
                    Item { y: 1, x: 11, color: "#cccccc", kind: ItemKind::FilledCircle },
                    ...
                    Item { y: 3, x: 3, color: "#cccccc", kind: ItemKind::FilledCircle },
                    ...
                    Item { y: 7, x: 9, color: "#cccccc", kind: ItemKind::FilledCircle },
                    Item { y: 7, x: 9, color: "black", kind: ItemKind::Circle },
                    Item { y: 7, x: 11, color: "black", kind: ItemKind::FilledCircle },
                    ...
                    Item { y: 9, x: 11, color: "black", kind: ItemKind::FilledCircle },
                ],
