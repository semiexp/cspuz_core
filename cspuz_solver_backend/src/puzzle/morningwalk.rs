...
pub fn solve(url: &str) -> Result<Board, &'static str> {
    ...
    let is_line = morningwalk::solve_morningwalk(&forest, &num).ok_or("no answer")?;
...
mod tests {
    ...
    fn test_solve() {
        compare_board!(
            solve("https://pzprxs.vercel.app/p?morningwalk/6/5/67h1c03j5t1j4j"),
            Board {
                kind: BoardKind::Grid,
                height: 5,
                width: 6,
                data: vec![
                    ...
                    Item { y: 1, x: 5, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 1, x: 7, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 1, x: 11, color: "black", kind: ItemKind::Num(5) },
                    Item { y: 3, x: 3, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 3, x: 5, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 3, x: 7, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 3, x: 9, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 5, x: 5, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 7, x: 3, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 7, x: 5, color: "black", kind: ItemKind::Num(1) },
                    Item { y: 7, x: 7, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 7, x: 9, color: "#e0d0ff", kind: ItemKind::Fill },
                    Item { y: 9, x: 3, color: "black", kind: ItemKind::Num(4) },
