...
mod tests {
    ...
    fn test_solve() {
        compare_board!(
            solve("https://puzz.link/p?tetrochain/7/5/i22e31a12p14"),
            Board {
                kind: BoardKind::Grid,
                height: 5,
                width: 7,
                data: vec![
                    ...
                    Item { y: 5, x: 1, color: "green", kind: ItemKind::Block },
                    Item { y: 5, x: 3, color: "black", kind: ItemKind::SideArrowLeft },
                    Item { y: 5, x: 3, color: "black", kind: ItemKind::Num(1) },
                    Item { y: 5, x: 5, color: "green", kind: ItemKind::Block },
                    Item { y: 5, x: 5, color: "green", kind: ItemKind::Block },
                    Item { y: 5, x: 7, color: "black", kind: ItemKind::SideArrowUp },
                    ...
                    Item { y: 9, x: 11, color: "green", kind: ItemKind::Block },
                    Item { y: 9, x: 13, color: "black", kind: ItemKind::SideArrowUp },
                    Item { y: 9, x: 13, color: "black", kind: ItemKind::Num(4) },
                ],
