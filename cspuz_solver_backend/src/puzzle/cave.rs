...
mod tests {
    ...
    fn test_solve() {
        compare_board_and_check_no_solution_case!(
            solve("https://puzz.link/p?cave/6/6/k3h6j2l7g3g2h3n"),
            Board {
                kind: BoardKind::Grid,
                height: 6,
                width: 6,
                data: vec![
                    ...
                    Item { y: 1, x: 11, color: "black", kind: ItemKind::Num(3) },
                    Item { y: 3, x: 1, color: "green", kind: ItemKind::Block },
                    Item { y: 3, x: 3, color: "green", kind: ItemKind::Block },
                    Item { y: 3, x: 5, color: "black", kind: ItemKind::Num(6) },
                    ...
                    Item { y: 7, x: 5, color: "black", kind: ItemKind::Num(7) },
                    Item { y: 7, x: 7, color: "green", kind: ItemKind::Dot },
                    Item { y: 7, x: 9, color: "black", kind: ItemKind::Num(3) },
